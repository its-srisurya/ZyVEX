...
const Login = () => {
    return (
        <div className='py-4 container mx-auto'>
            <h1 className='font-bold text-3xl text-center my-8' >Login/Signup to connect with your supporters</h1>
            <div className="social-login-btn">
                <div className="flex flex-col gap-2 min-h-screen items-center ">


                    <button
                        className="flex items-center bg-white border-2 border-black-700  rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-gray-800 hover:text-white hover:bg-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 w-[250px]">
                    ...
                    <button
                        className="flex items-center bg-white border-2 border-black-700 hover:border-black-700 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-gray-800  hover:text-white hover:bg-black focus:outline-none focus:ring-2 focus:ring-offset-2 w-[250px] focus:ring-gray-500">
                        <svg className="h-6 w-6 mr-2" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
                    ...
                    <button
                        className="flex items-center bg-white border-2 border-black-700 w-[250px] hover:border-black-700 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-gray-800  hover:text-white hover:bg-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                        <svg className="h-6 w-6 mr-2" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
                    ...
                    <button
                        className="flex items-center bg-white border-2 border-black-700 w-[250px] hover:border-black-700 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-gray-800 hover:text-white hover:bg-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                        <svg className="h-6 w-6 mr-2 fill-current" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
